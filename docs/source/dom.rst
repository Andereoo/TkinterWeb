...
To manipulate the Document Object Model, use the :prop:`~tkinterweb.HtmlFrame.document` property of your :class:`tkinterweb.HtmlFrame` or :class:`tkinterweb.HtmlLabel` widget (new since version 3.25). For example, to create a heading with blue text inside of an element with the id "container", one can use the following:
