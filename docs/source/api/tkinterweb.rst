...
This widget can be accessed through the :attr:`HtmlFrame.html` property of the :class:`HtmlFrame` and :class:`HtmlLabel` widgets to access underlying settings and commands that are not a part of the :class:`HtmlFrame` API.
